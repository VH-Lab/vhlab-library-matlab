function [im] = prairieviewquickmap(dirname,channel,resps,pixels,plotit,method,param1,param2)

%  PRAIRIEVIEWQUICKMAP - Produces a colored map of responses
%  IM=PRAIRIEVIEWQUICKMAP(DIRNAME,CHANNEL,RESPS,PIXELS,PLOTIT,METHOD,PARAM1,PARAM2)
%
...
%
%  RESPS is the responses, as output from PRAIRIEVIEWTUNINGCURVE.
%
...
im1 = previewprairieview(dirname,50,1,channel);
