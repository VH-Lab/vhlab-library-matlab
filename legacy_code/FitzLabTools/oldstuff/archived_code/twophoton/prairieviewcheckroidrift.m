function [im] = prairieviewcheckroidrift(dirname, channel, roirect, roiinds, roix,roiy,roiname, plotit)

%  PRAIRIEVIEWTUNINGCURVE - Tuning curve for PrairieView two-photon data
%
%  IM = PRAIRIEVIEWCHECKROIDRIFT(DIRNAME,CHANNEL,ROIRECT,ROIINDS,ROIX,ROIY,RIONAME, PLOTIT)
%
...
pv = previewprairieview(dirname,1,1,channel);
im0 = zeros(size(pv));
...
[data,t] = readprairieviewdata(dirname, [interval],{rectinds roiinds},0,channel);
