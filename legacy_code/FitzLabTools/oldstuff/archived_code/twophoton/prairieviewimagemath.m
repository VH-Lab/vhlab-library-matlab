function [result,im1,im2] = prairieviewimagemath(dirname, channel, stimcode1, stimcode2, op,plotit,name)

%  PRAIRIEVIEWIMAGEMATH - Simple image math
%
%  RESULT = PRAIRIEVIEWIMAGEMATH(DIRNAME,CHANNEL,STIMCODE1,STIMCODE2,OP,PLOTIT,NAME)
%
...
intinds = []; interval1 = []; interval2 = []; spinterval1 = []; spinterval2 = [];
...
[data,t] = readprairieviewdata(dirname, [interval1; spinterval1; interval2; spinterval2]-starttime,{find(im_outline==1)},0,1);
