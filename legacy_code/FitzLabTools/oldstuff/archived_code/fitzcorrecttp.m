function [newtimes,frame2dirnum] = fitzcorrecttp(params, filename)
% FITZCORRECTTP - Corrects time for prairieview twophoton files
%
%   [FRAMETIMES,FRAME2DIRNUM] = ...
%     FITZCORRECTTP({PARAMSTRUCT}, TIMEFILENAME)
%
...
catch, havefile = 0; spike2times = []; tptime0 = 0;
end;
