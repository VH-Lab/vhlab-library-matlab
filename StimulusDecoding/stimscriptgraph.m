function [stims, stimlabels] = stimscriptgraph(dirname, plotit)

%  STIMSCRIPTGRAPH - Graph of stimulus times
%
%  [STIMS,STIMLABELS]= STIMSCRIPTGRAPH(DIRNAME, PLOTIT)
%
...
%  
if exist([fixpath(dirname) 'stims.mat'])~=2, fitzlabstiminterview(dirname); end;
