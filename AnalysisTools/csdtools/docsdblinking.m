function [lfpmean,csdmean,lfp,csd,totaldepth]=docsd(dirnames, depths, channels, chanmap, chan0, int1, int2, comps)
...
for i=1:length(dirnames),
	...
	channelstoinclude,
	[lfpmean_,csdmean_,lfp_,csd_]=lfp_csd_comp_blinking(dirnames{i},channelstoinclude,chanmap,chan0,int1,int2,comps);
	if 1,
	if i==1,
