...
[f1f0,dirpref,oiind,tunewidth,cv,di,sig_ori,blank_rate, max_rate, coeff_var, pref, null, orth, fit, sig_vis] = extract_oridir_indexes(cell,...
	'TestType',TestType,'ColorType',ColorType);

otindexstruct = var2struct('f1f0','dirpref','oiind','tunewidth','cv','di','sig_ori','blank_rate', ...
		'max_rate', 'coeff_var', 'pref', 'null', 'orth', 'fit','sig_vis');
