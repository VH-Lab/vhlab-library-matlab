function [se,si,le,li,err,r2,fit] = color_fit_rect4switch(Lc,Sc,data,SE0, SI0, LE0, LI0,mysigns);
...
[x] = fminsearch(@(x) color_fit_rect4switch_err(x,Lc,Sc,data,mysigns),xo,options);
x = abs(x).*mysigns;
