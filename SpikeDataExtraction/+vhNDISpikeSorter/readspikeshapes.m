function [spikeshapes] = readspikeshapes(vhintanfilename, spikechannel, times, samples)
...
for i=1:numel(times),
	[spikeshapes(i,:)] = read_Intan_RHD2000_datafile(vhintanfilename,h,'amp',spikechannel,times(i)-3*time_samples,times(i)+3*time_samples);
