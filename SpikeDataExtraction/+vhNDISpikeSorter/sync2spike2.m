function [shift,scale] = sync2spike2(dirname, args)
% SYNC2SPIKE2 - Compute shift between Intan and Spike2 records
%
%  [SHIFT,SCALE] = SYNC2SPIKE2(DIRNAME)
%
...
%
%
%  See also: vhNDISpikeSorter.intan2spike2time
