% VHINTAN_THRESHOLDS - Describes the vhintan_thresholds.txt file for multichannel analysis
%
...
%   called "vhintan_thresholds.txt" that describes the thresholds that should
