function output_str = vhspike2_autothreshold_dir(dirname, varargin)
% VHSPIKE2_AUTOTHRESHOLD_DIR - Automatically determine spike threshold values for a directory
%
%  OUTPUT_STR = VHSPIKE2_AUTOTHRESHOLD_DIR(DIRNAME, ...)
%
...
saveStructArray([dirname filesep 'vhspike2_thresholds.txt'],threshold_struct,1);
