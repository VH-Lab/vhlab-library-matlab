function s=vhintan_filtermap_default
% VHINTAN_FILTERMAP_DEFAULT - Describes the vhintan_filtermap.txt file for multichannel analysis
%
...
%   called "vhintan_filtermap.txt" that describes how the channels should be 
