function output_str = vhintan_autothreshold_dir(dirname, varargin)
% VHINTAN_AUTOTHRESHOLD_DIR - Automatically determine spike threshold values for a directory
%
%  OUTPUT_STR = VHINTAN_AUTOTHRESHOLD_DIR(DIRNAME, ...)
%
