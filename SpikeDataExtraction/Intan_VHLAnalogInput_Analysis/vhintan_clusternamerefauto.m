function vhintan_clusternamerefauto(ds, name, ref)
% VHINTAN_CLUSTERNAMEREF - Cluster a name/reference pair collected using Intan using a single cluster for all spikes
%
...
[clusterids,CI] = cluster_spikewaves_trivial('waves',waves,'waveparameters',header,'windowlabel',['Sort spikes for name/ref ' name '/' int2str(ref)],...
