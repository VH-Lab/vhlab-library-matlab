function labels = vhintan_directorystatus2labels(dirnames, status)
% VHINTAN_DIRECTORYSTATUS2LABELS Converts directory status to a label
%
%   LABELS = VHINTAN_DIRECTORYSTATUS2LABELS(DIRNAMES, STATUS)
%
