% VHWILLOW_THRESHOLDS - Describes the vhwillow_thresholds.txt file for multichannel analysis
%
...
%   called "vhwillow_thresholds.txt" that describes the thresholds that should
