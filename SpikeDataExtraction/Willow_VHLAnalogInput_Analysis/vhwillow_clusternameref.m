function vhwillow_clusternameref(ds, name, ref)
% VHWILLOW_CLUSTERNAMEREF - Cluster a name/reference pair collected using Willow
%
%   VHWILLOW_CLUSTERNAMEREF(DS, NAME, REF)
%
...
%  text files called 'willow_st_name_ref_00M.txt', where M is the cluster number.
...
for i=1:length(dirlist),
    ...
    if fid<0, error(['Could not open file ' [dirname filesep 'willow_spiketimes_' int2str(channelgroupingnum) '.vst'] '.']); end;
