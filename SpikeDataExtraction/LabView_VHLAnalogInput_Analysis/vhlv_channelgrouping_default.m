function s = vhlv_channelgrouping_default
% VHLV_CHANNELGROUPING - Describes the vhlv_channelgrouping.txt file for multichannel analysis
%
...
%   called "vhlv_channelgroupings.txt" that describes how signals should
